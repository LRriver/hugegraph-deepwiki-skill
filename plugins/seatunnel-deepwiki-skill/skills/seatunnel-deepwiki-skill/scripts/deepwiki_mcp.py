...
class McpClient:
    ...
    def request(self, payload: dict[str, Any], expect_response: bool = True) -> Optional[dict[str, Any]]:
        ...
        headers = {
            ...
            "User-Agent": "seatunnel-deepwiki-skill/0.1.0",
        }
        if self.session_id:
    ...
    def initialize(self) -> None:
        self.rpc(
            "initialize",
            {
                ...
                "capabilities": {},
                "clientInfo": {"name": "seatunnel-deepwiki-skill", "version": "0.1.0"},
            },
        )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    ask.add_argument("--repo", default="seatunnel", help="Repository alias.")
    ...
    structure.add_argument("--repo", default="seatunnel", help="Repository alias.")

    contents = subparsers.add_parser("contents", help="Read wiki contents.")
    contents.add_argument("--repo", default="seatunnel", help="Repository alias.")
    ...
    context.add_argument("--repo", default="seatunnel", help="Repository alias.")
